...
<ul class="breadcrumb">
				...
				<li><a href="#">Todos Equipamentos</a></li>
			</ul>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Todos Equipamentos</h2>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th>Sub-categoria relacionada</th>
								  <th>Marca</th>
								  <th>Status</th>
								  <th>Actions</th>
							  </tr>
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{{ $v_product->subcategories_name }}</td>
								<td class="center">{{ $v_product->brands_name }}</td>
								<td class="center">
